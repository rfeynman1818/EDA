import argparse, csv, os, sys, glob, numpy as np
...
def load_filelist(txt_path, exts={".nitf",".ntf",".NITF",".NTF"}):
    ...
    # filter by extension and de-dup
...
def read_slc(path, dec=4):
    ...
    try:
        slc = rdr[::dec, ::dec]   # slicing is supported by SarPy readers
    finally:
        del rdr
    return slc
